...
from source.paths import DUMPS_DIR, PHASES, \
    get_data_filepath, PROCESSED_DATA_DIR
from source.helpers import tokenize, yield_lines, load_dump, dump, write_lines, count_line, \
    print_execution_time, save_preprocessor, yield_sentence_pair, generate_hash
...
#        pool.join()
    ...
    def preprocess_dataset(self, dataset):
        ...
        save_preprocessor(self, DUMPS_DIR)
